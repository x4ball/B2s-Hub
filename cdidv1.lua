...
local MainSection = Window:Section({Title = "Main",Icon = "",Opened = false,})
local MainTab = MainSection:Tab({Title = "Welcome",Icon = "house",Locked = false,})
MainTab:Paragraph({Title = "Welcome To B2s Hub Script!!",Desc = "I Hope You Enjoy B2s Hub,If the script have bug or somthing wrong, you can repots the bug in B2s Hub Server :]",Thumbnail = "https://i.ibb.co/1GVxksFK/static.png",ThumbnailSize = 80,Locked = false,Buttons = {{Icon = "square-arrow-out-up-right",Title = "Join The B2s Hub Discord",Callback = function() setclipboard("https://discord.gg/b2shub") end,}}})
local ChangelogTab = MainSection:Tab({Title = "Changelogs",Icon ="square-pen",Locked = false,})
ChangelogTab:Paragraph({Title = "Changelog For Cdid V1.1",Desc = "-Added new tab for teleport to a dealership and job",Tumbhanil = "https://i.ibb.co.com/R5ry5Y7/images-2.jpg",TumbhanilSize = 80,})
local PlayerSection = Window:Section({Title = "Player",Icon ="user",Opened = false,})